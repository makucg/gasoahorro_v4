  ...
  >
    <defs>
      <linearGradient id="gradient" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0%" stopColor="var(--nextui-background-gradientStart)" />
        <stop offset="100%" stopColor="var(--nextui-background-gradientEnd)" />
      </linearGradient>
    </defs>
    ...
    <text
      ...
      fill="var(--nextui-background-fillColor)"
      fontSize="16"
